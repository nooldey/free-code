...
import type { OpenCodeModelDefinition } from '../services/api/opencode-models.js'
...
export type GlobalConfig = {
  ...
  // OpenCode Zen 免费模型与手动补充模型的缓存目录。
  openCodeZenModelCatalogCache?: OpenCodeModelDefinition[]
